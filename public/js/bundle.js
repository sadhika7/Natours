...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic2FkaGlrYTciLCJhIjoiY2tjbTNjNTV5MHF4ODJ6dDgzYW85cWc3ZyJ9.tv74RTf9Z1C_59QTcG4OSQ';
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Signed up successfully! Please log in to continue.');
              window.setTimeout(function () {
...
var stripe = Stripe('pk_test_51H87UeE11FMNo7iryRChJkM0YQ5SD1GtYf7LVHe0L0b0qoPW61BnVr5ox6SDpEGqR9OaOGZvtfR6kTq7RuwYZ5jD00LAnSklvc');
